...
try:
    ...
    print("Error: Please enter valid integers for combat strength.")
    exit()
...
weaponRoll = diceRoll - 1  # Adjust for zero-based indexing in the weapons array
combatStrength += diceRoll

print("\nRolling for your weapon...")
print("You rolled a " + str(diceRoll) + ". Your weapon is: " + weapons[weaponRoll])
